...
void LevelParser::parseTilesets(TiXmlElement* pTilesetRoot, std::vector<Tileset>* pTileset) {
	...
	Tileset tileset;
	pTilesetRoot->FirstChildElement()->Attribute("width", &tileset.tileWidth);
	pTilesetRoot->FirstChildElement()->Attribute("height", &tileset.tileHeight);
	...
	tileset.numColumns = tileset.tileWidth / (tileset.tileWidth + tileset.spacing);
